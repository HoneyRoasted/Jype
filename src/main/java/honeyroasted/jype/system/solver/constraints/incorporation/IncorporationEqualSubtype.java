...
public class IncorporationEqualSubtype implements ConstraintMapper.Binary<TypeConstraints.Equal, TypeConstraints.Subtype> {
    ...
    @Override
    public void process(PropertySet context, ConstraintNode leftNode, TypeConstraints.Equal leftConstraint, ConstraintNode rightNode, TypeConstraints.Subtype rightConstraint) {
